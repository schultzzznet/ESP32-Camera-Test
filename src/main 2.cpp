...
void setup() {
  ...
  Serial.println("=== Testing Configuration 1: SDA=18, SCL=23 ===");
  scanI2C(18, 23);
  
  Serial.println("=== Testing Configuration 2: SDA=4, SCL=5 ===");
  scanI2C(4, 5);
  
  Serial.println("=== Testing Configuration 3: SDA=40, SCL=39 ===");
  scanI2C(40, 39);
  
  Serial.println("=== Testing Configuration 4: SDA=8, SCL=9 ===");
  scanI2C(8, 9);
  
  Serial.println("=== Testing Configuration 5: SDA=41, SCL=42 ===");
  scanI2C(41, 42);
